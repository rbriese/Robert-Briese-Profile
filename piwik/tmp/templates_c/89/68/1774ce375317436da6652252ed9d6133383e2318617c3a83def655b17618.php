...
class __TwigTemplate_89681774ce375317436da6652252ed9d6133383e2318617c3a83def655b17618 extends Twig_Template
{
    ...
    protected function doDisplay(array $context, array $blocks = array())
    {
        ...
        if (((array_key_exists("showLocation", $context)) ? (_twig_default_filter((isset($context["showLocation"]) ? $context["showLocation"] : $this->getContext($context, "showLocation")), false)) : (false))) {
            ...
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["visitData"]) ? $context["visitData"] : $this->getContext($context, "visitData")), "location"), "html", null, true);
            echo "\">
    <img src=\"";
            // line 9
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["visitData"]) ? $context["visitData"] : $this->getContext($context, "visitData")), "countryFlag"), "html", null, true);
            echo "\"/>&nbsp;<span>";
            if ((!twig_test_empty($this->getAttribute((isset($context["visitData"]) ? $context["visitData"] : $this->getContext($context, "visitData")), "city")))) {
                echo twig_escape_filter($this->env, $this->getAttribute((isset($context["visitData"]) ? $context["visitData"] : $this->getContext($context, "visitData")), "city"), "html", null, true);
            } else {
                echo twig_escape_filter($this->env, $this->getAttribute((isset($context["visitData"]) ? $context["visitData"] : $this->getContext($context, "visitData")), "country"), "html", null, true);
            }
            echo "</span>
</div>
";
    ...
    <ul>
        ...
        echo "</span><strong ";
        if ((!twig_test_empty($this->getAttribute((isset($context["visitData"]) ? $context["visitData"] : $this->getContext($context, "visitData")), "providerName")))) {
            echo "title=\"";
            ...
            echo ": ";
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["visitData"]) ? $context["visitData"] : $this->getContext($context, "visitData")), "providerName"), "html", null, true);
            echo "\"";
        }
        echo ">";
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["visitData"]) ? $context["visitData"] : $this->getContext($context, "visitData")), "visitIp"), "html", null, true);
        echo "</strong>
        </li>
        ...
        if (array_key_exists("widgetizedLink", $context)) {
            ...
            echo twig_escape_filter($this->env, twig_upper_filter($this->env, call_user_func_array($this->env->getFilter('translate')->getCallable(), array("General_Id"))), "html", null, true);
            echo " ";
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["visitData"]) ? $context["visitData"] : $this->getContext($context, "visitData")), "visitorId"), "html", null, true);
            echo "\">";
        }
        // line 20
        echo "                <strong>";
        ...
        if ($this->getAttribute((isset($context["visitData"]) ? $context["visitData"] : null), "plugins", array(), "any", true, true)) {
            echo twig_escape_filter($this->env, call_user_func_array($this->env->getFilter('translate')->getCallable(), array("UserSettings_BrowserWithPluginsEnabled", $this->getAttribute((isset($context["visitData"]) ? $context["visitData"] : $this->getContext($context, "visitData")), "browserName"), $this->getAttribute((isset($context["visitData"]) ? $context["visitData"] : $this->getContext($context, "visitData")), "plugins"))), "html", null, true);
        } else {
            echo twig_escape_filter($this->env, call_user_func_array($this->env->getFilter('translate')->getCallable(), array("UserSettings_BrowserWithNoPluginsEnabled", $this->getAttribute((isset($context["visitData"]) ? $context["visitData"] : $this->getContext($context, "visitData")), "browserName"))), "html", null, true);
        }
        echo "\">
                <img src=\"";
        // line 28
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["visitData"]) ? $context["visitData"] : $this->getContext($context, "visitData")), "browserIcon"), "html", null, true);
        echo "\"/><span>";
        echo twig_escape_filter($this->env, $this->getAttribute(twig_split_filter($this->getAttribute((isset($context["visitData"]) ? $context["visitData"] : $this->getContext($context, "visitData")), "browserName"), " "), 0, array(), "array"), "html", null, true);
        echo "</span>
            </div>
            <div class=\"visitor-profile-os\">
                <img src=\"";
        // line 31
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["visitData"]) ? $context["visitData"] : $this->getContext($context, "visitData")), "operatingSystemIcon"), "html", null, true);
        echo "\"/><span>";
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["visitData"]) ? $context["visitData"] : $this->getContext($context, "visitData")), "operatingSystemShortName"), "html", null, true);
        echo "</span>
            </div>
        </li>
        <li><span>";
        ...
        echo "</span><strong>";
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["visitData"]) ? $context["visitData"] : $this->getContext($context, "visitData")), "resolution"), "html", null, true);
        echo "</strong></li>
        ";
        // line 35
        if (array_key_exists("visitReferralSummary", $context)) {
            ...
            <strong ";
            // line 39
            if ((($this->getAttribute((isset($context["visitData"]) ? $context["visitData"] : $this->getContext($context, "visitData")), "referrerType") == "search") && !twig_in_filter("(", (isset($context["visitReferralSummary"]) ? $context["visitReferralSummary"] : $this->getContext($context, "visitReferralSummary"))))) {
                echo "title=\"";
...
<div class=\"visitor-profile-latest-visit-column\">
    <ul>
        ...
        $context['_seq'] = twig_ensure_traversable($this->getAttribute((isset($context["visitData"]) ? $context["visitData"] : $this->getContext($context, "visitData")), "customVariables"));
        $context['loop'] = array(
        ...
        foreach ($context['_seq'] as $context["id"] => $context["customVariable"]) {
            // line 47
            echo "        ";
            if (($this->getAttribute((isset($context["loop"]) ? $context["loop"] : $this->getContext($context, "loop")), "index0") < 4)) {
                // line 48
                echo "            ";
                echo $context["macros"]->getcustomVar((isset($context["id"]) ? $context["id"] : $this->getContext($context, "id")), (isset($context["customVariable"]) ? $context["customVariable"] : $this->getContext($context, "customVariable")));
                echo "
        ";
            }
            // line 50
    ...
    ";
        // line 52
        if ((twig_length_filter($this->env, $this->getAttribute((isset($context["visitData"]) ? $context["visitData"] : $this->getContext($context, "visitData")), "customVariables")) > 4)) {
            // line 53
