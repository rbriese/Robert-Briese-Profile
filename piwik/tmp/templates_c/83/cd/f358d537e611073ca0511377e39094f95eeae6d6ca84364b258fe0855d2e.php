...
class __TwigTemplate_83cdf358d537e611073ca0511377e39094f95eeae6d6ca84364b258fe0855d2e extends Twig_Template
{
        ...
        ";
            ...
            if ((!array_key_exists("ecommerce", $context))) {
                ...
                if ($this->getAttribute((isset($context["topDimensions"]) ? $context["topDimensions"] : null), "country", array(), "any", true, true)) {
                    ...
                    echo " ";
                    $this->env->loadTemplate("@Goals/_listTopDimension.twig")->display(array_merge($context, array("topDimension" => $this->getAttribute((isset($context["topDimensions"]) ? $context["topDimensions"] : $this->getContext($context, "topDimensions")), "country"))));
                    echo "</li>
            ";
                }
                // line 12
                echo "            ";
                if (($this->getAttribute((isset($context["topDimensions"]) ? $context["topDimensions"] : null), "keyword", array(), "any", true, true) && (twig_length_filter($this->env, $this->getAttribute((isset($context["topDimensions"]) ? $context["topDimensions"] : $this->getContext($context, "topDimensions")), "keyword")) > 0))) {
                    // line 13
                    echo "                <li>";
                    ...
                    echo " ";
                    $this->env->loadTemplate("@Goals/_listTopDimension.twig")->display(array_merge($context, array("topDimension" => $this->getAttribute((isset($context["topDimensions"]) ? $context["topDimensions"] : $this->getContext($context, "topDimensions")), "keyword"))));
                    echo "</li>
            ";
                }
                // line 15
                echo "            ";
                if (($this->getAttribute((isset($context["topDimensions"]) ? $context["topDimensions"] : null), "website", array(), "any", true, true) && (twig_length_filter($this->env, $this->getAttribute((isset($context["topDimensions"]) ? $context["topDimensions"] : $this->getContext($context, "topDimensions")), "website")) > 0))) {
                    // line 16
                    echo "                <li>";
                    ...
                    echo " ";
                    $this->env->loadTemplate("@Goals/_listTopDimension.twig")->display(array_merge($context, array("topDimension" => $this->getAttribute((isset($context["topDimensions"]) ? $context["topDimensions"] : $this->getContext($context, "topDimensions")), "website"))));
                    echo "</li>
            ";
                }
                // line 18
