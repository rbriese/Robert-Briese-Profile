...
class __TwigTemplate_57534b5ff9ca27b33ee597b724932464cb20b4350fc9b9b99b7d8e496327b1f2 extends Twig_Template
{
    ...
    <div>
        <div class=\"visitor-profile-visit-title-row\"><h2 class=\"visitor-profile-visit-title\" data-idvisit=\"";
            // line 4
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["visitInfo"]) ? $context["visitInfo"] : $this->getContext($context, "visitInfo")), "getColumn", array(0 => "idVisit"), "method"), "html", null, true);
            echo "\" title=\"";
            ...
            echo "</h2>";
            if (($this->getAttribute((isset($context["visitInfo"]) ? $context["visitInfo"] : $this->getContext($context, "visitInfo")), "getColumn", array(0 => "visitDuration"), "method") != 0)) {
                echo "<span>&nbsp;- (";
                echo $this->getAttribute((isset($context["visitInfo"]) ? $context["visitInfo"] : $this->getContext($context, "visitInfo")), "getColumn", array(0 => "visitDurationPretty"), "method");
                echo ")</span>";
            }
            echo "<span class=\"visitor-profile-date\" title=\"";
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["visitInfo"]) ? $context["visitInfo"] : $this->getContext($context, "visitInfo")), "getColumn", array(0 => "serverDateTimePrettyFirstAction"), "method"), "html", null, true);
            echo "\">";
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["visitInfo"]) ? $context["visitInfo"] : $this->getContext($context, "visitInfo")), "getColumn", array(0 => "serverDatePrettyFirstAction"), "method"), "html", null, true);
            echo "</span></div>
        <ol class=\"visitor-profile-actions\">
            ";
            // line 6
            $this->env->loadTemplate("@Live/_actionsList.twig")->display(array_merge($context, array("actionDetails" => $this->getAttribute((isset($context["visitInfo"]) ? $context["visitInfo"] : $this->getContext($context, "visitInfo")), "getColumn", array(0 => "actionDetails"), "method"), "clientSideParameters" => array("filterEcommerce" => false, "idSite" => (isset($context["idSite"]) ? $context["idSite"] : $this->getContext($context, "idSite")), "pageUrlNotDefined" => call_user_func_array($this->env->getFilter('translate')->getCallable(), array("General_NotDefined", call_user_func_array($this->env->getFilter('translate')->getCallable(), array("Actions_ColumnPageURL"))))), "overrideLinkStyle" => false)));
            // line 13
            echo "        </ol>
    </div>
</li>
